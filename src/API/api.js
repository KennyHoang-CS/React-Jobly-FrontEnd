...
class JoblyApi {
    ...
    static async getCompanyList(searchValues = {}) {
        let res = await this.request(`companies`, searchValues);
    ...
    static async getJobsList(searchValues = {}) {
        let res = await this.request(`jobs`, searchValues);
        return res.jobs;
    }
